...
@semester varchar(15), @Roll varchar(7), @courseid int, @section varchar(1), @gpa float
as
if(@gpa >= 2.5)
begin
INSERT [dbo].[Registration] ([Semester], [RollNumber], [CourseID], [Section],GPA)
VALUES (@semester, @Roll, @courseid, @section, @gpa)
end
else
begin
Print('You can only enroll in subjects that need to be improved.')
end

execute enroll 'Fall2016','1',20,'A',3.3

select * from Registration

execute enroll 'Fall2016','1',20,'A',2.4
